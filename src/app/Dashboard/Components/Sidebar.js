          ...
          <ul className="space-y-1 bg-transparent mt-5">
            ...
            {role === "superadmin" && flag === "false" ? (
              ...
              <>
                ...
                <div className="bg-transparent">
                  <li className={`flex items-center p-3 cursor-pointer hover:border-b-2 rounded-lg bg-transparent ${isOpenManagement
                    ? "border-l-4 border-b-2 border-red-400"
                    : "text-blue"
                    } ${activeLink === "/Dashboard/Models/Manufacturer/GetManufacturers" ||
                      activeLink === "/Dashboard/Models/CarModels/GetCarsModels" ||
              ...
              <>
                ...
                <div className="bg-transparent">
                  <li className={`flex items-center p-3 cursor-pointer hover:border-b-2 mx-2 bg-transparent ${isOpenManagement
                    ? "border-b-2 border-white"
                    : "text-blue"
                    } ${activeLink === "/Dashboard/Models/Manufacturer/GetManufacturers" ||
                      activeLink === "/Dashboard/Models/CarModels/GetCarsModels" ||
