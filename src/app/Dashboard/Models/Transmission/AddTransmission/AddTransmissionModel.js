...
const AddTransmissionModel = ({ isOpen, onClose, fetchData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${API_URL_Transmission}`, formData);
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-xl">
        ...
        {success && (
          <p className="text-green-600">Transmission added successfully!</p>
        )}
...
export default AddTransmissionModel;
