    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
      <div className="p-4 sm:p-6 rounded-lg shadow-lg w-full bg-white max-w-lg sm:max-w-2xl md:max-w-3xl max-h-[80vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:space-x-4">
            ...
            <div className="flex flex-col flex-1">
              ...
              <select
                ...
                className="mt-1 p-2 border border-gray-300 rounded"
              >
                <option value="">Select Tax Cycle</option>
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:space-x-4">
            <div className="flex flex-col flex-1 mb-4 sm:mb-0">
              <label className="text-sm font-medium">MOT Due Date:</label>
              <input
                type="date"
                name="motDueDate"
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:space-x-4">
            ...
            <div className="flex flex-col flex-1">
              <label className="text-sm font-medium">ABI Code:</label>
              <input
                type="text"
                name="abiCode"
                value={formData.abiCode}
                onChange={handleChange}
                className="mt-1 p-2 border border-gray-300 rounded"
              />
            </div>
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:space-x-4">
            ...
            <div className="flex flex-col flex-1">
              <label className="text-sm font-medium">Next Service Miles:</label>
              <input
                type="number"
          ...
          <div className="flex flex-col">
            <label className="text-sm font-medium">Road Tax Cost:</label>
            <input
              type="number"
              name="roadTaxCost"
              value={formData.roadTaxCost}
              onChange={handleChange}
